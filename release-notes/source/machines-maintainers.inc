...
This ensures, in long term, all board with a maintainer assigned.
...
is expected that they properly fix the kernel issue (when it´s a kernel issue). However anything out of community control
should be workrounded anyway.
